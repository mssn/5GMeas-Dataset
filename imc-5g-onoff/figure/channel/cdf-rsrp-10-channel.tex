...
\begin{axis}[
   table/col sep=comma,
    ...
    xmax    = 100,
    width   =  3cm,
    height  =  4.5cm, % 5cm for 1.8in --> 3.6cm for 1.3in (5 * 1.3/1.8 = 3.6)
    %grid = both,
...
table[
y expr = \thisrowno{0},
x expr = \thisrowno{1}*100,
] {loc_rsrp_10_cdf-t-387410.csv};
...
\legend{387410,398410,501390,521310};
