...
\begin{axis}[
    ...
    ytick = {1,2,3,4,5},
    yticklabels = {174770,632736,658080,648672,653952},
...
x = N2E2_normalized,
col sep=comma,
] {type_channel_ratio_breakdown_av_5g.csv};
%\addlegendentry{\texttt{5GAIR}}
...
\draw[mark=none, thin, dashed, gray] (axis cs:0,3.5) -- (axis cs:1.2,3.5);

\node[center, text=black, rotate = 270] at (axis cs:1.1,2) {\bf OP$_{A}$};
\node[center, text=black, rotate = 270] at (axis cs:1.1,4.5) {\bf OP$_{V}$};
