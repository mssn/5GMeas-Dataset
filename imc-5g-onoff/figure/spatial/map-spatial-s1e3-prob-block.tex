...
%/pgfplots/colormap={jet2}{rgb255(0cm)=(0,100,200) rgb255(0.5cm)=(0,200,200) rgb255(1cm)=(100,200,100) rgb255(2.5cm)=(200,200,0) rgb255(5cm)=(200,0,0)}
%}
...
\begin{document}
	...
	\begin{tikzpicture}
		...
		%after end axis/.append code={
			...
			x = {lon_index},
      y = {lat_index},
			meta = run_with_onoff_ratio,
			col sep=comma,
			]
	{onoff_grid_stats_spatial_s1e3_t_0.0005_0509_index.csv};
