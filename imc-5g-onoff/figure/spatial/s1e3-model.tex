...
x expr = \thisrowno{0},
y expr = \thisrowno{1},
] {piecewise_ratio_learned_threshold_onoff_location_stats_spatial_s1e3_t_0509.csv};
...
%    },
			...
			%		file {data.dat};
			table[
			x = rsrp_50_gap_273_371_387410,
			y = run_with_onoff_ratio,
			col sep=comma,
			]
			{onoff_location_stats_spatial_s1e3_t_0509.csv};

%\legend{Fit model, Data points};

\node[center, text=myred, rotate=0] at (axis cs: 35,0.9) {\bf Spearman};
\node[center, text=myred, rotate=0] at (axis cs: 35,0.75) {\bf Corr: -0.65};
