...
] {cell_dur_ratio_cdf_0.0001_subroute3_459_520110.csv};
...
x expr = \thisrowno{0}*100,
y expr = \thisrowno{1}*100,
] {cell_dur_ratio_cdf_0.0001_subroute3_317_520110.csv};
...
x expr = \thisrowno{0}*100,
y expr = \thisrowno{1}*100,
] {cell_dur_ratio_cdf_0.0001_subroute3_749_520110.csv};
...
x expr = \thisrowno{0}*100,
y expr = \thisrowno{1}*100,
] {cell_dur_ratio_cdf_0.0001_subroute3_721_520110.csv};
...
x expr = \thisrowno{0}*100,
y expr = \thisrowno{1}*100,
] {cell_dur_ratio_cdf_0.0001_subroute3_700_125290.csv};
...
\addplot+[mark=none, dashed, line width=.2pt,gray!50t] coordinates {(-5,75) (110,75)};
\addplot+[mark=none, dashed, line width=.2pt,gray!50t] coordinates {(25,0) (25,100)};

\addplot+[mark=none, dashed, line width=.2pt,gray!50t] coordinates {(-5,50) (110,50)};
\addplot+[mark=none, dashed, line width=.2pt,gray!50t] coordinates {(40,0) (40,100)};

\legend{C1, C2, C3, C4, C6};
