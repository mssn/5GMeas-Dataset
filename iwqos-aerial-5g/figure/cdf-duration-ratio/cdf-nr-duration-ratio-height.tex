...
] {nr_duration_ratio_cdf_120_0.0001_r1_all_new.csv};
...
x expr = \thisrowno{0}*100,
y expr = \thisrowno{1}*100,
] {nr_duration_ratio_cdf_90_0.0001_r1_all_new.csv};
...
x expr = \thisrowno{0}*100,
y expr = \thisrowno{1}*100,
] {nr_duration_ratio_cdf_60_0.0001_r1_all_new.csv};
%{A-R1_thput_cdf_picked_grid_0405-0930_5gs_5gs_310410_0.0005_0_0_short.csv};
%{A-R1_thput_cdf_picked_grid_0407_0807_5gs_5gs_310410_0.0005_0_0_short.csv};
...
x expr = \thisrowno{0}*100,
y expr = \thisrowno{1}*100,
] {nr_duration_ratio_cdf_30_0.0001_r1_all_new.csv};
...
x expr = \thisrowno{0}*100,
y expr = \thisrowno{1}*100,
] {nr_duration_ratio_cdf_0_0.0001_r1_all_new.csv};
