...
\pgfplotstableread{
	lw lq med  uq uw
4.1	4.9	6.3	8.5	11.1
16.3	19.8	33.1	39.4	43.1
21.5	26.1	33.2	40.7	51
18.2	24.9	29.1	38.3	44.3
22.9	25.1	28.9	36.8	55.7
}\datatablea
...
\pgfplotstableread{
	lw lq med  uq uw
2.4	3.4	5.2	7	8
10.2	11.3	13.8	14.4	16.9
2.3	8.2	11.4	13.9	18.2
1.1	2.8	8.2	14.5	18.3
5	5.4	7.8	18.8	41.8
}\datatableb
...
% outlier 
%\if 0
\addplot[only marks,draw=myblue,fill=white,mark=*,mark size=1pt,fill opacity=0.2] table[x=y,y expr=(\thisrow{x} - 1)*4+2.5] \outlierdatatablea;
...
\addplot[only marks,draw=myred,fill=white,mark=*,mark size=1pt,fill opacity=0.2] table[x=y,y expr=(\thisrow{x} - 1)*4+1.5] \outlierdatatableb;
%\fi 
