...
\begin{document}
	...
	\begin{tikzpicture}
		...
		xtick style={draw=none},
			ytick={1, 2, 3, 4, 5},
			yticklabels={C5, C4, C3, C2, C1},
			%yticklabels={0m, 30m, 60m, 90m, 120m},
			xtick={40.461475,40.463225},
			xticklabels={100m,300m},
			%ylabel = {Altitude (m)},
		xlabel={SR1},
		xlabel style={
                        %font=\normalsize,
...
%	colormap/hot2,
		...
		colorbar style={
			...
			x = grid_lat,
			y = cell_index,
			meta = thput_sample_ratio,
			col sep=comma,
			]
			{all_lat_height_nr_cell_thput_1214-0214_0.0001_subroute4.csv};
