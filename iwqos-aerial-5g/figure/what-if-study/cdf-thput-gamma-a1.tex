...
] {thput_gain_ratio_cdf_120_0.0005_a1_all_new.csv};
...
x expr = \thisrowno{0},
y expr = \thisrowno{1}*100,
] {thput_gain_ratio_cdf_60_0.0005_a1_all_new.csv};
...
x expr = \thisrowno{0},
y expr = \thisrowno{1}*100,
] {thput_gain_ratio_cdf_0_0.0005_a1_all_new.csv};
...
%\node[text=black] at (axis cs:50,75) {\bf 10\%};
...
%\addplot+[mark=none,dashed,gray,line width=1pt] coordinates {(0,0) (0,102)};
