...
\pgfplotstableread{
	lw lq med  uq uw
1.3	1.9	4	15.6	51.5
392.7	480.8	566.8	709.9	1167.9
100.2	203.8	312.5	428.7	581.1
}\datatablea


\pgfplotstableread{
	lw lq med  uq uw
1.9	7.8	43.1	69.2	102.3
287.2	405.8	532.9	835.6	1207.7
127.4	187.5	656.1	1670.4	1997
}\datatableb

\pgfplotstableread{
	lw lq med  uq uw
0.7	2.2	7.6	37.6	93.7
126	303.7	494.3	727.2	1193.1
71.2	206.8	436.4	831.9	1500.5
}\datatablec
...
\begin{semilogxaxis}[
    ...
    ymin    =  0,
    width   =  3.4 cm,
    height  =  2.5 cm, % 0.9in % 5cm for 1.8in --> 3.6cm for 1.3in (5 * 1.3/1.8 = 3.6)
    axis y,
    %axis y line*=left,
    xtick align = inside,
...
\pgfplotsinvokeforeach{0,...,\TotalRows}
{
	...
	boxplot prepared={
		...
		%		every whisker/.style={very thin,black,solid},
		%		every median/.style={very thick,blue,solid},},
	every box/.style={thick,gray,solid},
...
% outlier 
%\if 0
\addplot[only marks,draw=myred,fill=white,mark=*,mark size=1pt,fill opacity=0.2] table[x=y,y expr=(\thisrow{x} - 1)*4+3] \outlierdatatablea;
...
\addplot[only marks,draw=myblue,fill=white,mark=*,mark size=1pt,fill opacity=0.2] table[x=y,y expr=(\thisrow{x} - 1)*4+2] \outlierdatatableb;
\addplot[only marks,draw=gray,fill=white,mark=*,mark size=1pt,fill opacity=0.2] table[x=y,y expr=(\thisrow{x} - 1)*4+1] \outlierdatatablec;
%\fi 
...
\addplot[mark=none, solid,black,line width=0.5pt] coordinates {(0.01,4) (10000,4)} ;
\addplot[mark=none, solid,black,line width=0.5pt] coordinates {(0.01,8) (10000,8)};
\addplot[mark=none, solid,black,line width=0.5pt] coordinates {(0.01,12) (10000,12)};
\addplot[mark=none, solid,black,line width=0.5pt] coordinates {(0.01,16) (10000,16)};
