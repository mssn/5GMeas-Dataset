...
] {nr_serving_rsrp_cdf_120_0.0001_r1.csv};
...
x expr = \thisrowno{0},
y expr = \thisrowno{1}*100,
] {nr_serving_rsrp_cdf_90_0.0001_r1.csv};
...
x expr = \thisrowno{0},
y expr = \thisrowno{1}*100,
] {nr_serving_rsrp_cdf_60_0.0001_r1.csv};
...
x expr = \thisrowno{0},
y expr = \thisrowno{1}*100,
] {nr_serving_rsrp_cdf_30_0.0001_r1.csv};
...
x expr = \thisrowno{0},
y expr = \thisrowno{1}*100,
] {nr_serving_rsrp_cdf_0_0.0001_r1.csv};
...
\if 0
\addplot+[mark=none, dashed, line width=.2pt,gray!50t] coordinates {(-200,50) (0,50)};
\addplot+[mark=none, dashed, line width=.2pt,gray!50t] coordinates {(-90,0) (-90,100)};
\addplot+[mark=none, dashed, line width=.2pt,gray!50t] coordinates {(-106.5,0) (-106.5,100)};
\fi
